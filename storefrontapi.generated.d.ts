...
export type HeroProductsQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type HeroProductsQuery = {
...
export type PaginateProductsQueryVariables = StorefrontAPI.Exact<{
...
export type PaginateProductsQuery = {
  products: {
    nodes: Array<
      Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle'> & {
        priceRange: {
...
export type ProductForCollectionQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type ProductForCollectionQuery = {
...
export type ProductForRelatedQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type ProductForRelatedQuery = {
  product?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Product, 'id' | 'handle' | 'title'> & {
      featuredImage?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Image, 'id' | 'altText' | 'url' | 'width' | 'height'>
...
export type MoneyRelatedFragment = Pick<
  StorefrontAPI.MoneyV2,
  'amount' | 'currencyCode'
>;
...
export type RelatedCollectionQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  first?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['Int']['input']>;
...
export type RelatedCollectionQuery = {
  collection?: StorefrontAPI.Maybe<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  fragment HeroProduct on Product {\n    id\n    title\n    handle\n    images(first: 10) {\n      nodes {\n        id\n        url\n        altText\n        width\n        height\n      }\n    }\n  }\n  query HeroProducts(\n    $handle: String!\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    collection(handle: $handle) {\n      id\n      title\n      products(first: 8) {\n        nodes {\n          ...HeroProduct\n        }\n      }\n    }\n  }\n': {
    return: HeroProductsQuery;
    variables: HeroProductsQueryVariables;
  };
  ...
  '#graphql\n  fragment ProductCard on Product {\n    id\n    title\n    handle\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n    images(first: 1) {\n      nodes {\n        id\n        url\n        altText\n        width\n        height\n      }\n    }\n  }\n  query PaginateProducts(\n    $first: Int!\n    $after: String\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    products(first: $first, after: $after, sortKey: UPDATED_AT, reverse: true) {\n      nodes {\n        ...ProductCard\n      }\n      pageInfo {\n        hasNextPage\n        endCursor\n      }\n    }\n  }\n': {
    return: PaginateProductsQuery;
    variables: PaginateProductsQueryVariables;
  };
  ...
  '#graphql\n          #graphql\n  fragment MoneyProductItem on MoneyV2 {\n    amount\n    currencyCode\n  }\n  fragment ProductItem on Product {\n    id\n    handle\n    title\n    featuredImage {\n      id\n      altText\n      url\n      width\n      height\n    }\n    priceRange {\n      minVariantPrice {\n        ...MoneyProductItem\n      }\n      maxVariantPrice {\n        ...MoneyProductItem\n      }\n    }\n  }\n\n          query ProductForCollection($handle: String!, $country: CountryCode, $language: LanguageCode) @inContext(country: $country, language: $language) {\n            product(handle: $handle) { ...ProductItem }\n          }\n        ': {
    return: ProductForCollectionQuery;
    variables: ProductForCollectionQueryVariables;
  };
  '#graphql\n  #graphql\n  fragment MoneyProductItem on MoneyV2 {\n    amount\n    currencyCode\n  }\n  fragment ProductItem on Product {\n    id\n    handle\n    title\n    featuredImage {\n      id\n      altText\n      url\n      width\n      height\n    }\n    priceRange {\n      minVariantPrice {\n        ...MoneyProductItem\n      }\n      maxVariantPrice {\n        ...MoneyProductItem\n      }\n    }\n  }\n\n  query Collection(\n    $handle: String!\n    $country: CountryCode\n    $language: LanguageCode\n    $first: Int\n    $last: Int\n    $startCursor: String\n    $endCursor: String\n  ) @inContext(country: $country, language: $language) {\n    collection(handle: $handle) {\n      id\n      handle\n      title\n      description\n      products(\n        first: $first,\n        last: $last,\n        before: $startCursor,\n        after: $endCursor\n      ) {\n        nodes {\n          ...ProductItem\n        }\n        pageInfo {\n          hasPreviousPage\n          hasNextPage\n          endCursor\n          startCursor\n        }\n      }\n    }\n  }\n': {
  ...
  '#graphql\n          #graphql\n  fragment MoneyRelated on MoneyV2 {\n    amount\n    currencyCode\n  }\n  fragment RelatedProductItem on Product {\n    id\n    handle\n    title\n    featuredImage { id altText url width height }\n    priceRange {\n      minVariantPrice { ...MoneyRelated }\n      maxVariantPrice { ...MoneyRelated }\n    }\n  }\n\n          query ProductForRelated($handle: String!, $country: CountryCode, $language: LanguageCode) @inContext(country: $country, language: $language) {\n            product(handle: $handle) { ...RelatedProductItem }\n          }\n        ': {
    return: ProductForRelatedQuery;
    variables: ProductForRelatedQueryVariables;
  };
  ...
  '#graphql\n  #graphql\n  fragment MoneyRelated on MoneyV2 {\n    amount\n    currencyCode\n  }\n  fragment RelatedProductItem on Product {\n    id\n    handle\n    title\n    featuredImage { id altText url width height }\n    priceRange {\n      minVariantPrice { ...MoneyRelated }\n      maxVariantPrice { ...MoneyRelated }\n    }\n  }\n\n  query RelatedCollection(\n    $handle: String!\n    $country: CountryCode\n    $language: LanguageCode\n    $first: Int\n  ) @inContext(country: $country, language: $language) {\n    collection(handle: $handle) {\n      handle\n      title\n      products(first: $first) {\n        nodes { ...RelatedProductItem }\n      }\n    }\n  }\n': {
    return: RelatedCollectionQuery;
    variables: RelatedCollectionQueryVariables;
  };
